...
| `kenx-infra` | `/theme <paper\|light\|dark>`, `/theme-bg <true\|false>`, `/filetree`, `/switch-statusbar <1-8\|0>` | Themes, optional full-TUI background fill, right-side file picker, and custom statusbar/input UI. Runtime preferences are stored under `~/.pi/agent/state/kenx-infra.json`. |
