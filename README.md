...
| `kenx-infra` | `/theme <paper\|light\|dark>`, `/filetree`, `/switch-statusbar <1-8\|0>` | Themes, right-side file picker, and custom statusbar/input UI. Runtime preferences are stored under `~/.pi/agent/state/kenx-infra.json`. |
